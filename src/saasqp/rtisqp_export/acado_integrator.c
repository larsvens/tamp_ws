...
a[4] = (cos(xd[2]));
a[5] = (sin(xd[2]));
a[6] = (((real_t)(3.6000000000000000e+05)*(((real_t)(1.4199999999999999e+00)*xd[3])-xd[5]))/xd[4]);
...
out[3] = ((real_t)(4.4444444444444447e-04)*(((real_t)(1.0400000000000000e+00)*u[0])-((real_t)(1.4199999999999999e+00)*a[6])));
out[4] = ((real_t)(6.6666666666666664e-04)*u[1]);
out[5] = (((real_t)(6.6666666666666664e-04)*(u[0]+a[6]))-(xd[4]*xd[3]));
out[6] = u[2];
}
...
a[17] = (((real_t)(5.1120000000000000e+05))*a[16]);
a[18] = (a[16]*a[16]);
a[19] = ((real_t)(0.0000000000000000e+00)-(((real_t)(3.6000000000000000e+05)*(((real_t)(1.4199999999999999e+00)*xd[3])-xd[5]))*a[18]));
a[20] = (((real_t)(-3.6000000000000000e+05))*a[16]);
a[21] = (((real_t)(5.1120000000000000e+05))*a[16]);
a[22] = ((real_t)(0.0000000000000000e+00)-(((real_t)(3.6000000000000000e+05)*(((real_t)(1.4199999999999999e+00)*xd[3])-xd[5]))*a[18]));
a[23] = (((real_t)(-3.6000000000000000e+05))*a[16]);
...
out[33] = ((real_t)(4.4444444444444447e-04)*((real_t)(0.0000000000000000e+00)-((real_t)(1.4199999999999999e+00)*a[17])));
out[34] = ((real_t)(4.4444444444444447e-04)*((real_t)(0.0000000000000000e+00)-((real_t)(1.4199999999999999e+00)*a[19])));
out[35] = ((real_t)(4.4444444444444447e-04)*((real_t)(0.0000000000000000e+00)-((real_t)(1.4199999999999999e+00)*a[20])));
out[36] = (real_t)(0.0000000000000000e+00);
out[37] = ((real_t)(4.6222222222222227e-04));
...
out[48] = (real_t)(6.6666666666666664e-04);
out[49] = (real_t)(0.0000000000000000e+00);
out[50] = (real_t)(0.0000000000000000e+00);
out[51] = (real_t)(0.0000000000000000e+00);
out[52] = (real_t)(0.0000000000000000e+00);
out[53] = (((real_t)(6.6666666666666664e-04)*a[21])-xd[4]);
out[54] = (((real_t)(6.6666666666666664e-04)*a[22])-xd[3]);
out[55] = ((real_t)(6.6666666666666664e-04)*a[23]);
out[56] = (real_t)(0.0000000000000000e+00);
out[57] = (real_t)(6.6666666666666664e-04);
...
acadoWorkspace.rk_diffsNew2[(i * 10) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)7.4999999999999997e-03 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-03;
}
}
...
for (i = 0; i < 7; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 10) + (run1 + 7)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)7.4999999999999997e-03 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-03;
}
}
...
rk_eta[6] += + acadoWorkspace.rk_kkk[12]*(real_t)7.4999999999999997e-03 + acadoWorkspace.rk_kkk[13]*(real_t)2.5000000000000001e-03;
if( run == 0 ) {
for (i = 0; i < 7; ++i)
{
for (j = 0; j < 7; ++j)
