...
class TrackInterface:
    def __init__(self):
        ...
        self.track_iface_mode = "get_track_from_yaml" # tmp remove get_track_from_yaml get_fssim_track
        ds = 1.0 # step size in s 
        plot_track = False
        ...
        if(self.track_iface_mode == "get_fssim_track"):

            # get cone positions left and right from the /fssim/track message
            cl_X = []
            cl_Y = []
        ...
        if plot_orientation:   
            ...
            axs[0].plot(s,psic_out,'k*')
            axs[0].set_title('psic_out')
